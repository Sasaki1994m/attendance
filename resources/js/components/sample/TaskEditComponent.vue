      ...
      <div class="col-sm-6">
        <form v-on:submit.prevent="submit" >
          ...
          <div class="form-group row">
              ...
              <input type="text" class="col-sm-9 form-control-plaintext"  id="id" v-model="task.title">
          </div>
          <div class="form-group row">
              <label for="content" class="col-sm-3 col-form-label">Content</label>
              <!-- <input type="text" class="col-sm-9 form-control" id="content"> -->
              <input type="text" class="col-sm-9 form-control-plaintext"  id="id" v-model="task.content">
          </div>
          <div class="form-group row">
              <label for="person-in-charge" class="col-sm-3 col-form-label">Person In Charge</label>
              <!-- <input type="text" class="col-sm-9 form-control" id="person-in-charge"> -->
              <input type="text" class="col-sm-9 form-control-plaintext"  id="id" v-model="task.person_in_charge">
          </div>
